...
class DatabaseHelper {
  ...
  static const columnStock = 'stock'; // New column for initial stock
  static const columnSold = 'sold';
  static const columnRemaining = 'remaining';
        ...
        onCreate: (db, version) {
          return db.execute('''
            CREATE TABLE $table (
              ...
              $columnSold INTEGER NOT NULL DEFAULT 0,  -- Sold items, default 0
              $columnRemaining INTEGER AS ($columnStock - $columnSold) STORED,  -- Automatically calculated
